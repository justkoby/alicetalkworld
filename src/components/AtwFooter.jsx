    ...
    <footer className="atw-footer-section">
      <div className="atw-footer-container">
        <div className="atw-footer-top-grid">
          ...
          {/* Column 6: Follow Us */}
          <div className="atw-footer-col atw-footer-desktop-only">
            <h4 className="atw-footer-col-title">Follow Us</h4>
            <ul className="atw-footer-links-list">
              <li><a href="https://web.facebook.com/alicetalkworld" target="_blank" rel="noopener noreferrer">Facebook</a></li>
              <li><a href="https://www.instagram.com/alicetalkworld/" target="_blank" rel="noopener noreferrer">Instagram</a></li>
              <li><a href="https://www.linkedin.com/in/alicetalkworld-gh-24b513243/" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
              <li><a href="https://twitter.com/alicetalkworld" target="_blank" rel="noopener noreferrer">X (Twitter)</a></li>
            </ul>
          </div>

          {/* Column 7: Newsletter Signup */}
