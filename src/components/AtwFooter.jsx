    ...
    <footer className="atw-footer-section">
      <div className="atw-footer-container">
        <div className="atw-footer-top-grid">
          ...
          {/* Column 2: Address */}
          <div className="atw-footer-address-col">
            <p>Nii Sai Road</p>
            <p>Accra, Ghana</p>
            <a href="mailto:atw@alicetalkworld.org" className="atw-footer-email-link">
              atw@alicetalkworld.org
            </a>
          </div>

          {/* Column 3: Links */}
          <div className="atw-footer-links-col">
            <ul className="atw-footer-links-list">
              <li><a href="contact.html" className="atw-footer-link">Contact Us</a></li>
              <li><a href="about.html#faqs" className="atw-footer-link">FAQs</a></li>
              <li><a href="get-involved.html" className="atw-footer-link">Get Involved</a></li>
              <li><a href="donation.html" className="atw-footer-link">Donate</a></li>
              <li><a href="our-team.html" className="atw-footer-link">Our Team</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="atw-footer-bottom">
          ...
          <div className="atw-footer-socials">
            {/* Facebook */}
            <a 
              href="https://web.facebook.com/alicetalkworld" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="atw-footer-social-icon"
              aria-label="Facebook"
            >
            ...
            {/* Twitter */}
            <a 
              href="https://twitter.com/alicetalkworld" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="atw-footer-social-icon"
              aria-label="Twitter"
            ...
            {/* Instagram */}
            <a 
              href="https://www.instagram.com/alicetalkworld/" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="atw-footer-social-icon"
            ...
            {/* LinkedIn */}
            <a 
              href="https://www.linkedin.com/in/alicetalkworld-gh-24b513243/" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="atw-footer-social-icon"
              aria-label="LinkedIn"
          ...
          <div className="atw-footer-legal-container">
